...
import { Box, Heading, Button, VStack, Field, Input, Text, Card, Flex, Avatar, Stack, Switch, Spinner, Alert } from '@chakra-ui/react'
      ...
      <Card.Root mb={6}>
        <Card.Body>
          <Flex align="center" gap={4}>
            <Avatar.Root size="xl">
              <Avatar.Fallback name={user?.surname || user?.username || 'User'} />
            </Avatar.Root>
            <Box>
              <Text fontWeight="bold" fontSize="lg">
                {user?.surname || user?.username || 'User'}
              </Text>
